              ...
              <div className="mt-2">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <button
                    ...
                    <a
                      href="https://buy.stripe.com/test_00gg1R5O83QoaKk6op"
                      className="text-center ml-1 bg-gray-900 text-white font-bold rounded-lg px-2 py-1.5 hover:bg-gray-600"
                  >
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 25 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6 inline-block mr-1">
